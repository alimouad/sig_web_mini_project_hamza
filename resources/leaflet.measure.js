(function (factory, window) {
    ...
    L.Measure = {
        linearMeasurement: "Distance measure",
        areaMeasurement: "Area measure",
        start: "St",
        meter: "m",
        kilometer: "km",
        squareMeter: "m²",
    ...
    L.MeasureLable = L.Layer.extend({
        ...
        enableClose: function () {
            ...
            this._closeButton.innerHTML =
                '<svg class="icon" viewBox="0 0 40 40"><path stroke="#FF0000" stroke-width="4" d="M 10,10 L 30,30 M 30,10 L 10,30" /></svg>';
